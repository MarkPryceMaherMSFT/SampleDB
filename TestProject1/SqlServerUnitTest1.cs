...
namespace TestProject1
{
    ...
    public class SqlServerUnitTest1 : SqlDatabaseTestClass
    {
        ...
        private void InitializeComponent()
        {
            ...
            Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction dbo_Procedure5Test_TestAction;
            ...
            this.dbo_Procedure5TestData = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestActions();
            dbo_Procedure1Test_TestAction = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction();
            inconclusiveCondition1 = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.Conditions.InconclusiveCondition();
            dbo_Procedure5Test_TestAction = new Microsoft.Data.Tools.Schema.Sql.UnitTesting.SqlDatabaseTestAction();
            ...
            // 
            // dbo_Procedure5TestData
            // 
            this.dbo_Procedure5TestData.PosttestAction = null;
            this.dbo_Procedure5TestData.PretestAction = null;
            this.dbo_Procedure5TestData.TestAction = dbo_Procedure5Test_TestAction;
            // 
            // dbo_Procedure5Test_TestAction
            // 
            dbo_Procedure5Test_TestAction.Conditions.Add(inconclusiveCondition2);
            resources.ApplyResources(dbo_Procedure5Test_TestAction, "dbo_Procedure5Test_TestAction");
            // 
        ...
        [TestMethod()]
        public void dbo_Procedure5Test()
        {
            SqlDatabaseTestActions testActions = this.dbo_Procedure5TestData;
            // Execute the pre-test script
            // 
            System.Diagnostics.Trace.WriteLineIf((testActions.PretestAction != null), "Executing pre-test script...");
            SqlExecutionResult[] pretestResults = TestService.Execute(this.PrivilegedContext, this.PrivilegedContext, testActions.PretestAction);
        ...
        private SqlDatabaseTestActions dbo_Procedure5TestData;
    }
}
