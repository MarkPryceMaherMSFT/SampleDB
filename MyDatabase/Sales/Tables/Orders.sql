CREATE TABLE [Sales].[Orders] (
    ...
    CONSTRAINT [CK_Orders_FilledDate] CHECK ([FilledDate]>=[OrderDate] AND [FilledDate]<'01/01/2020'),
    CONSTRAINT [CK_Orders_OrderDate] CHECK ([OrderDate]>'01/01/2005' AND [OrderDate]<'01/01/2020'),
